...
const buyadsFrom = document.querySelector('.form--ads');
const uploadadsFrom = document.querySelector('.form--uploadads');
...
if (buykioskFromGeo)
  ...
  if (buyadsFrom)
  buyadsFrom.addEventListener('submit', e => {
    e.preventDefault();
    const title = document.getElementById('title').value;
    const mimeType = document.getElementById('address').value;
    const category = document.getElementById('description').value;
    const date = document.getElementById('date').value;
    const displayHours = document.getElementById('operatingHours').value;
    const displayDays = document.getElementById('operatingDays').value;
    buykiosk(
      title,
      mimeType,
      category,
