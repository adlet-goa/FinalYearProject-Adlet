...
var buykiosk = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, address, description, operatingHours, operatingDays) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Purchase Registered');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
  ...
  return function buykiosk(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var buykioskForm = document.querySelector('.form--buykiosk'); // DELEGATION
...
if (buykioskForm) buykioskForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  ...
  (0, _buykiosk.buykiosk)(name, address, description, operatingHours, operatingDays);
});
