...
var buykiosk = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, address, lat, lon, description, operatingHours, operatingDays, screenSize) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (buykioskForm) buykioskForm.addEventListener('submit', function (e) {
  ...
  (0, _buykiosk.buykiosk)(name, address, lat.lon, description, operatingHours, operatingDays, screenSize);
});
